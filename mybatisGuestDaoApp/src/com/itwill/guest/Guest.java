...
public class Guest {
	...
	public Guest(Integer guest_no, String guest_name, String guest_date, String guest_email, String guest_homepage,
	...
	public Integer getGuest_no() {
		return guest_no;
	}

	public void setGuest_no(Integer guest_no) {
		this.guest_no = guest_no;
	}
