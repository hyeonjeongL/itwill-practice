...
public class SpringApplicationContextAnnotationMain {
	...
	public static void main(String[] args) {
		...
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("1.bean_create_annotation.xml");
		...
		GuestService guestService2 = (GuestService) applicationContext.getBean("guestService");
		...
		System.out.println("--------------Container에 있는 모든 빈객체 참조 얻기--------------");
