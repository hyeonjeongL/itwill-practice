...
public class RequestParamModelAttributeController {
	...
	public String parpameter_guest_write_action(@RequestParam String guest_name, 
		...
		Guest insertGuest = new Guest(0, guest_name, guest_name, guest_email, guest_homepage, guest_title, guest_content);
	...
	public String model_attribute_quest_write_action(@ModelAttribute Guest guest) {
